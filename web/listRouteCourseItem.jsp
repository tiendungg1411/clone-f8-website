                                ...
                                <c:forEach items="${listRouteTypeItem}" var="i">
                                    <tr>
                                        ...
                                        <td style="display: flex
                                            "><button name="btn_edit" onclick="window.location = ' editRouteCourseItem?id=${i.id}'" value="${i.id}" type="button" style="text-decoration: none;color: black; width: 70px; cursor: pointer;font-size: 14px">Chỉnh sửa</button> 
                                            <div name="btn_delete" onclick="deleteRTI(${i.id})" value="${itemCourse.getCourseID()}"    class="btn_delete" style="text-align: center;justify-content: center;margin-left: 10px; width: 50px; cursor: pointer;height: 25px;border:1px #807171 solid;border(${i.id}-radius: 2px;background-c(${i.id})olor: #F0F0F0 ;font-size: 10px">Xóa</div>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
