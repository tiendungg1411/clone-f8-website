...
public class passwordChange extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String oldPasswordEncrypt = passwordEncryption.encoder(oldPassword);
        String newPassword = request.getParameter("newPassword");
        String confirmNewPassword = request.getParameter("confirmNewPassword");
        String newPasswordEncrypt = passwordEncryption.encoder(newPassword);
...
//            2. check oldpassword trung password co ten gui ve tu jsp
        if (!password.trim().equals(oldPasswordEncrypt.trim())) {
...
//                  request.getRequestDispatcher("home").forward(request, response);
                ...
                response.sendRedirect("home?changePasswordStatus=Change password successfully");
            }
        }
