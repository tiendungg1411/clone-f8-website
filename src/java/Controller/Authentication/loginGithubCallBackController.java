...
import static Controller.registerEmailServlet.generateRandomUsername;
 ...
 * @author dell
 */
public class loginGithubCallBackController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet loginGithubCallBackController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet loginGithubCallBackController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String redirectUri = "http://localhost:9999/g4/loginGithubCallBack"; // Thay thế bằng đường dẫn tới servlet GitHubCallbackServlet
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) {
            ...
            if (userResponseCode == HttpURLConnection.HTTP_OK) {
                ...
                if (acc != null) {
//                    response.getWriter().print(acc.toString());
